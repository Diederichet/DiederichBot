...
denied_links = [
    "https://tenor.com/view/stop-sign-red-gif-25972505",
...
async def on_message(message):
    ...
    if "GOON" in content:
        ...
        await message.channel.send(
            "Rule 5: Absolutely no G**NING Allowed!1!"
        )
...
async def main():
    async with bot:
        ...
        await bot.load_extension("functions.fun")
        await bot.load_extension("functions.tarot")

        print("Loaded extensions: fun, tarot")
